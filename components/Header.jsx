...
export default function Header({ handleMenuToggle }) {
    ...
    return (
        <>
            <nav className='font-josefin flex fixed w-full justify-start lg:justify-between items-center px-6 h-16 bg-white text-gray-700 border-b border-gray-200 z-10'>
