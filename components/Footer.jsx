        ...
        <>
            <nav className='font-josefin flex w-full flex-col-reverse lg:flex-row lg:justify-evenly items-center mt-[60px] mb-[20px] p-[40px] bg-white text-gray-700 border-t border-gray-200'>
                <div className='p-[40px] flex justify-evenly items-center'>
                    <a className='p-[10px]' rel="noopener noreferrer" target="__blank" href="https://www.instagram.com/parkerbacall/" >
                        <Image
                            alt="Instagram Logo"
                            width={35}
                            height={35}
                    ...
                    <a className='p-[10px]' rel="noopener noreferrer" target="__blank" href="https://www.parkerbacall.com/" >
                        <Image
                    ...
                    <a className='p-[10px]' rel="noopener noreferrer" target="__blank" href="https://www.sentimentalskull.com/" >
                        <Image
